...
adult_timeseries <- ggplot() +
  ...
  theme_classic() +
  labs(y = "Adult Nicothoid Density") +
...
larvae_timeseries <- ggplot() +
  ...
  theme_classic() +
  labs(y = "Larval Nicothoid Density") +
  scale_x_continuous(name = "Development Day",
...
total_nicos_timeseries <- ggplot() +
  ...
  theme_classic() +
  labs(y = "Total Nicothoid Density") +
  scale_x_continuous(name = "Development Day",
                     breaks = seq(0, max(tot_counts_new$day), by = 2)) +
  scale_y_continuous(labels = function(y) format(y, scientific = TRUE)) + 
  theme(text = element_text(family = "Times New Roman"),
...
table_one = data.frame(
  ...
  "Mean Intensity of Larvae in Gill Chamber" = c("14282.9 ± 21755.7 <br> (n = 19)", "235.2 ± 373.3 <br> (n = 10)", "24 ± 31.7 <br> (n = 3)", "42 ± 59.2 <br> (n = 6)", "4608 ± 5578 <br> (n = 4)", "61.7 ± 34.2 <br> (n = 7)"))

...
colnames(table_one_df) <- c("Species", "Sex", "Prevalence Infested", "Prevalence with Adults <br> in Egg Mass", "Mean Density of Nicothoid <br> Eggs in Host Eggs", "Mean Density of <br> Larvae in Host Eggs", "Mean Density of Adults <br> in Host Eggs", "Mean Density of <br> Larvae in Gills")

#create the table 
final_table_one <- table_one_df %>%
  kable(html_font = "Times New Roman", 
      digits = 0,
      align = "c",
      booktabs = T, 
      escape = F) %>%
  kable_styling(latex_options = c("striped","hold_position", html_font = "Times New Roman", full_width = F, font_size = 10)) %>%
